...
class DocumentUpdate(BaseModel):
    """Correzione manuale dei campi di un documento (diciture e attribuzioni).
    Tutti i campi sono opzionali: si aggiornano solo quelli inviati
    (model_dump(exclude_unset=True)), consentendo anche di azzerarli a null."""
